  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (data?.user && data.session === null) {
        // This means email verification is enabled
      ...
      <div className="glass glass-glow w-full max-w-md p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Start tracking your internships today
          </p>
        </div>
        ...
        {successMsg && (
          <div className="mb-6 p-4 rounded-lg bg-green-900/30 border border-green-500/50 text-green-200 text-sm">
            {successMsg}
          </div>
        )}
